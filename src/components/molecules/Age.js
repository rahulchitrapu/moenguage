...
import SelectCompo from "./materialUI/SelectCompo";
...
export default function Age({
  ...
  useEffect(() => {
    ...
    setControlValue([parseInt(min), parseInt(max)]);
  }, [min, max]);
      ...
      <div>
        <form>
          ...
          >
            ...
            {/* <SelectCompo control={control} setControl={setControl} arr={arr}/> */}
          ...
          <input
            ...
            className={error ? "error number" : "number"}
            required
            value={min}
